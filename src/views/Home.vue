  ...
  <div class="home">
    <v-container class="grey lighten-5">
      <v-row class="mb-6" justify="center" no-gutters>
        <v-col lg="3" cols="6" class="adfgsadius mt-7 ml-3">
          <div>
            ...
            >
              <strong>
                অনেক সময় কলাম ছোট বড় করা লাগতে পারে তখন - শিমুল কে বলতে হবে</strong
              >
            </v-alert>
          </div>
        </v-col>
          ...
          <v-col cols="3" lg="4" class="ml-3">
            ...
            >
             <router-link to="/covid19">
              <v-img class="white--text align-end " src="/img/forweb-update-2.png">
              </v-img>
               </router-link>
               <v-card-title class="yellow--text text--lighten-1 dfcdacasdcs"
                  ><strong>Iecdr</strong></v-card-title
